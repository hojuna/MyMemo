...
독 옆 빈 공간에 붙어 할 일과 메모를 항상 보여줍니다. 공간이 좁으면 작아졌다가, 마우스를 올리면 펼쳐집니다.
...
| 🔍 **좁으면 작게, 올리면 펼침** | 독 옆 공간이 좁으면 자동으로 작은 칩이 되고, 마우스를 올리면 독 위로 커지며 전체 내용을 보여줬다가 다시 접힙니다. |
...
<table>
  <tr>
    ...
    <td align="center" width="33%">
      <img src="assets/screenshots/compact.png" width="100%" alt="공간이 좁을 때" /><br/>
      <sub><b>공간이 좁을 때</b><br/>자동으로 작은 칩 (올리면 펼침)</sub>
    </td>
  </tr>
</table>
